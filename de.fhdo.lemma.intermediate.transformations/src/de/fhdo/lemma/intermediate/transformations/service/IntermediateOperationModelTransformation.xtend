...
class IntermediateOperationModelTransformation
    ...
    override prepareInputModel(TransformationModelDescription modelDescription, EObject modelRoot) {
        ...
        if (operationModel.t_modelUri === null)
       ...
       operationModel.imports.forEach[
        ...
        // Populate the model's operation node, which specify a technology, with Technology instances
    ...
    override getInputModelValidator(TransformationModelDescription modelDescription) {
        return new OperationModelTransformationValidator
    }
